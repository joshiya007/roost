                        ...
                        <div class="tab-pane fade in active" id="submit-property-1">
                            <div class="card">
                                <div class="card__header">
                                    ...
                                    <small>Manage your profile, leads, listings and more.</small>
                                </div>
                                <form class="card__body">
                                    <form class="tab-pane active in fade" id="top-nav-loginuser">
                                        ...
                                        <a href="#submit-property-2" data-toggle="tab" class="btn btn--circle btn-warning submit-property__button">
                            ...
                            <div class="card">
                                ...
                                <form class="card__body">
                                    <form class="tab-pane fade forgot-password" id="top-nav-forgot-password">
                                        ...
                                        <a href="#submit-property-3" data-toggle="tab" class="btn btn--circle btn-success submit-property__button">
                                            <i class="zmdi zmdi-check"></i>
                                        </a>
                                    </form>
